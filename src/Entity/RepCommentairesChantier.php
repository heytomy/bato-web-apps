...
#[ORM\Entity(repositoryClass: RepCommentairesChantierRepository::class)]
class RepCommentairesChantier
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(name: 'Commentaire_Chantier', type: Types::TEXT)]
    ...
    #[ORM\ManyToOne(inversedBy: 'repCommentairesChantiers')]
    ...
    private ?CommentairesChantier $parent = null;
    ...
    public function getParent(): ?CommentairesChantier
    {
        return $this->parent;
    }

    public function setParent(?CommentairesChantier $parent): self
    {
        $this->parent = $parent;
