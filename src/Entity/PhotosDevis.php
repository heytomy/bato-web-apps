...
#[ORM\Entity(repositoryClass: PhotosDevisRepository::class)]
class PhotosDevis
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'photosDevis')]
    #[ORM\JoinColumn(name: 'CodeDevis', referencedColumnName: 'Id', nullable: false)]
    private ?DevisARealiser $codeDevis = null;
    ...
    public function getCodeDevis(): ?DevisARealiser
    {
        return $this->codeDevis;
    }

    public function setCodeDevis(?DevisARealiser $codeDevis): self
    {
